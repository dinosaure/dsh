...
(* OASIS_START *)
(* DO NOT EDIT (digest: 192c09d61591d4c56fd2c95fac06f47e) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_variant",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_variant", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "index.ml"});
               Test
                 ({
                     cs_name = "generate";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "variant_test.ml"});
               Test
                 ({
                     cs_name = "test_variant";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_variant"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\183p6,\213\204\162\175\186<\0164\129qR>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
