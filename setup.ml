...
(* OASIS_START *)
(* DO NOT EDIT (digest: ceb76dd7ecfecafda086a3ffdd2c4984) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "w_test.ml"});
               Test
                 ({
                     cs_name = "test_w";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\030\162!\2418\208\2247;-\140uh\215\146\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
