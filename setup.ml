...
(* OASIS_START *)
(* DO NOT EDIT (digest: a43153c0f0209fcf59096da1daf484dc) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "dscheme"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "dscheme.ml"});
               Executable
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\131\137-\220B\253\240#P\011\133\0068\175\177\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
