...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8a5f5ecd5f22b9eb9c2e4071ea32cd0c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "top.ml"});
               Executable
                 ({
                     cs_name = "dsh";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "z\229_j>\188!\175c'\238~\251\149Q\179";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
