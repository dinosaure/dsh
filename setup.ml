...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a81ffbfb4f8dc0e76dac359cec0376c) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_lexer",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_lexer", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_type",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_type", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_alias",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_alias", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "dsh"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "dsh.ml"});
               Executable
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "parser_test.ml"});
               Test
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_parser"
                        ]
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lexer_test.ml"});
               Test
                 ({
                     cs_name = "test_lexer";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "type_test.ml"});
               Test
                 ({
                     cs_name = "test_type";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "alias_test.ml"});
               Test
                 ({
                     cs_name = "test_alias";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\243\204\247\232C\t\208kr\175\135\1935\022\205\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
